<x-app-layout>
    <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden text-center p-6">
            <h1 class="text-3xl font-bold text-center text-blue-600 dark:text-blue-400">404 - La página no fue encontrada</h1>
            <p class="text-lg font-semibold mt-4 text-gray-700 dark:text-gray-300">
                Lo sentimos, la página que buscas no existe.
            </p>
            <img src="https://media.tenor.com/tOZbj3IX_VkAAAAM/spongebob-sponge.gif" alt="Spongebob Sponge" class="mx-auto mt-6 rounded-lg max-w-xs">
