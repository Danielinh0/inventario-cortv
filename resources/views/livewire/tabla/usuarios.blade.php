                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                            <tr>
                                ...
                                @include('livewire.includes.table-sort-th', ['name' => 'user_id', 'displayName' => 'Nombre', 'sortDir' => $sortDir])
                                @include('livewire.includes.table-sort-th', ['name' => 'NoFiltro', 'displayName' => 'Email', 'sortDir' => $sortDir])
