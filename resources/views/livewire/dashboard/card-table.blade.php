...
<div class="
    ...
    <div class="
        ...
        xs:w-[33px] xs:h-[33px]
        md:w-[36px] md:h-[36px]
        lg:w-[34px] lg:h-[38px]" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30"
            fill="none">
            <path d="{{$this->icon()}}" stroke="#3F403D" stroke-width="2"
    ...
    lg:w-[70%] lg:gap-[5px]  lg:items-start">
        ...
        md:text-[17px]"
            style="font-family: 'Times New Roman'">
            <span class="font-bold">Encargado:</span>
        ...
        md:text-[17px]"
            ...
            <span>{{$this->fecha_formateada()}}</span>
        </div>
    ...
    md:w-1/4">
        ...
        <div class="flex justify-center items-center">
                ...
                xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                    ...
                    <g filter="url(#filter0_d_113_112)">
                        {{-- Modificar la flecha en sentido y color basado en si entraron o salieron productos --}}
                        <path d="{{$cantidad < 0 ? "M8.75 16.25L15 22.5L21.25 16.25M8.75 7.5L15 13.75L21.25 7.5" : "M21.25 13.75L15 7.5L8.75 13.75M21.25 22.5L15 16.25L8.75 22.5"}}" stroke="{{$cantidad<0?"#EE4949":"#5EA836"}}"
        ...
        <div class=" {{$cantidad<0?'text-[#EE4949]':'text-[#5EA836]'}}
        font-times text-[22px] font-bold leading-[120%] tracking-[-0.36px]
        xs:text-[24px]"
            style="font-family: 'Times New Roman'">
            <span>{{abs($cantidad)}}</span>
            <span>pz</span>
        </div>
