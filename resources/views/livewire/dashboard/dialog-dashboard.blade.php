...
<div class="bg-[#AE2B2F] flex flex-col shadow-lg rounded-[10px] h-[220px] items-center justify-center
    ...
    <div>
        <div class="svg">
                {{-- SVG de demanda (flecha arriba/Alerta) segun el caso --}}
                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
                    <path d="{{$tipo === 'demanda' ? 'M4.5 36L18 22.5L26.612 31.112C29.1018 26.2043 33.209 22.3062 38.24 20.076L43.72 17.636M43.72 17.636L31.84 13.074M43.72 17.636L39.16 29.516' : 'M24 16V24M24 32H24.02M44 24C44 35.0457 35.0457 44 24 44C12.9543 44 4 35.0457 4 24C4 12.9543 12.9543 4 24 4C35.0457 4 44 12.9543 44 24Z'}}"
    ...
    <div class="flex flex-col items-center gap-[5px]">
        ...
        <h2 class="text-white text-center text-[20px] font-semibold leading-[120%] tracking-[-0.5px]"
            style="font-family: 'Times New Roman'">
            {{ $tipo === 'demanda' ? 'Producto en demanda' : 'Más stock en existencia' }}
        </h2>
